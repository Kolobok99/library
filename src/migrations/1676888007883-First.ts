...
export class First1676888007883 implements MigrationInterface {
    name = 'First1676888007883'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "subscriptions" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, CONSTRAINT "PK_a87248d73155605cf782be9ee5e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "books_entity" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "description" character varying, "subscriptionId" integer, CONSTRAINT "UQ_9e7710dcf6ac96859d41eb30ea4" UNIQUE ("title"), CONSTRAINT "PK_2c244e2a14402a6a9f943295412" PRIMARY KEY ("id"))`);
